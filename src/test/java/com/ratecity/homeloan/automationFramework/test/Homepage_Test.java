...
//	@Test()
	public void fn_ComparepagePart2() throws Exception {
		...
		//HomeLoanLandingpage.fn_CopyRightedInfoIsPresent();
		//HomeLoanLandingpage.fn_VerifyRateCityLogoisDisplayed();
		//HomeLoanLandingpage.fn_VerifyFooterMenuisDisplayed();
		//HomeLoanLandingpage.fn_DisclaimerisDisplayed();
		//HomeLoanLandingpage.fn_CheckAboutUsIsWorking();
		//HomeLoanLandingpage.fn_CheckContactUsIsWorking();
